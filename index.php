...
<div id="home_img2">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 " >
				<div><a href="furniture.php?name=popular"><img src="image/background1.jpg" width="100%" alt=""><br><br>
					<p class="text-center">SOFAS & LOUNGERS</p></a></div>
			</div>
			<div class="col-md-6">
				<div><a href="furniture.php?name=popular"><img src="image/beds1.jpg" width="100%" height="304px" alt="">
					<br><br>
					<p class="text-center">BED'S</p></a>
				</div>
			</div>
			<div class="col-md-6">
				<div><a href="furniture.php?name=popular"><img src="image/chair1.jpg" width="100%" height="304px" alt="">
					<br><br>
					<p class="text-center">CHAIR</p></a>
				</div>
			</div>
			<div class="col-md-6">
				<div><a href="furniture.php?name=popular"><img src="image/kitchen1.jpg" width="100%" height="304px" alt="">
					<br><br>
