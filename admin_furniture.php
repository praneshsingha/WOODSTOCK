        ...
        <div class="container-fluid" >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type="number" name="mfg_date" id="mfg_date" placeholder="Total"></td>
              ...
              if (isset($_GET["efun"])) 
              {
                echo "<table class='table'>";
                  ...
                  $row2 = mysqli_fetch_array($result2);
                    echo "<tbody>";
                    echo "<form action='admin_furniture.php' method='POST' enctype='mtlyipart/form-data'>";
                    echo "<tr>";
                    ...
                    echo "</select></td>";
                    // echo "<td><input type='file' name ='image' id='image' value='".$row2["image"]."' ></td>";
                ...
                if (isset($_POST["u_submit"])) 
                {
                  ...
                  //     }
                  // }
                  $updtfun = "UPDATE furniture SET name = '$name', description='$description',cost = '$cost',color='$color', total = '$total',category = '$category' WHERE c_id = '$c_id'";
